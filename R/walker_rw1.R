...
#' 
#' This is a non-exported function for performing time-varying model where all coefficients ~ rw1.
#' Function is used in comparing "naive" and ss versions in vignette.
#' 
